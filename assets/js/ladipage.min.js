...
LadiPageScriptV2.prototype.loadDataset = function(t, e, i, a, n, o, r, d) {
		...
		if (!isEmptyLadiPage(e.runtime.eventData) && !e.runtime.tmp.is_run_show_popup) {
			...
			if (Object.keys(e.runtime.eventData).forEach(function(t) {
					...
					if ("section" == a.type) {
						...
						d = document.getElementById(t), isEmptyLadiPage(d) || (n = d.offsetTop, (window.scrollY >= n && window.scrollY <= n + d.offsetHeight || window.scrollY + e.getHeightDevice() >= n && window.scrollY + e.getHeightDevice() <= n + d.offsetHeight || n >= window.scrollY && window.scrollY + e.getHeightDevice() >= n) && (e.runtime.scroll_to_section[t] = !0, e.runEventTracking(t, {
							is_form: !1
						})))
					}
				}), e.runtime.isClient) {
				...
				for (var s = Math.round((window.scrollY + e.getHeightDevice()) / document.body.clientHeight * 100), l = function(t) {
					...
					}, c = 1; c < e.const.PERCENT_TRACKING_SCROLL.length; c++) {
					var u = e.const.PERCENT_TRACKING_SCROLL[c];
					s > e.const.PERCENT_TRACKING_SCROLL[c - 1] && s <= u && -1 == e.runtime.scroll_depth.indexOf(u) && (e.runtime.scroll_depth.push(u), isFunctionLadiPage(window.gtag) && window.gtag("event", "ScrollDepth_" + u + "_percent", {
						event_category: "LadiPageScrollDepth",
						event_label: window.location.host + window.location.pathname,
						non_interaction: !0
					}), isFunctionLadiPage(window.fbq) && window.fbq("trackCustom", "ScrollDepth_" + u + "_percent"), isNullLadiPage(window.ttq) || l(s))
				}
			}
	...
	if (this.runtime.isClient) {
		...
		var f = function(t) {
				...
				isEmptyLadiPage(r) || (-1 != ["AddPaymentInfo", "AddToCart", "AddToWishlist", "CompleteRegistration", "Contact", "CustomizeProduct", "Donate", "FindLocation", "InitiateCheckout", "Lead", "PageView", "Purchase", "Schedule", "Search", "StartTrial", "SubmitApplication", "Subscribe", "ViewContent"].indexOf(r) && (n = "track"), isEmptyLadiPage(c) || isEmptyLadiPage(u) || ((e = {}).value = c, e.currency = u), !t && isObjectLadiPage(window.ladi_conversion_api) && isObjectLadiPage(window.ladi_conversion_api.facebook) && isArrayLadiPage(window.ladi_conversion_api.facebook.pixels) && (a = l()), d.push({
					...
					isFunctionLadiPage(window.fbq) && window.fbq(e.fbq_track_name, e.conversion_name, e.fbq_data, e.fbq_event_data), s = [{
						key: e.fbq_track_name,
						name: e.conversion_name,
						custom_data: e.fbq_data,
			...
			v = function(t) {
				...
				}) : isFunctionLadiPage(window.gtag) && window.gtag("event", "conversion", {
					send_to: "AW-" + d + "/" + s
				}));
				var i = null;
				if (!isEmptyLadiPage(r)) {
					...
					i = {
						event_category: a,
						event_label: window.location.host + window.location.pathname
					}, isEmptyLadiPage(c) || isEmptyLadiPage(u) || (i.value = c, i.currency = u), t ? o.runtime.tmp.runActionPopupX({
						conversion_name: r,
						gtag_data: i,
						action: {
							type: "run_tracking_gtag"
						}
					}) : isFunctionLadiPage(window.gtag) && window.gtag("event", r, i)
				}
			},
			P = function(t) {
				var e = null;
				if (isObjectLadiPage(i) && (e = {
					...
					}) : isNullLadiPage(window.ttq) || window.ttq.identify(e)), !isEmptyLadiPage(r)) {
					if (-1 != ["Purchase", "Lead"].indexOf(r)) return;
					var a = null;
					"CompletePayment" != r || isEmptyLadiPage(c) || isEmptyLadiPage(u) || ((a = {}).value = c, a.currency = u), t ? o.runtime.tmp.runActionPopupX({
						conversion_name: r,
						ttq_data: a,
						action: {
							type: "run_tracking_ttq"
						}
					}) : isNullLadiPage(window.ttq) || window.ttq.track(r, a)
				}
				_ && (o.runLadiPageCommand(function(e) {
					...
					}) : isNullLadiPage(window.ttq) || window.ttq.track(e.name), !0
				}), t ? o.runtime.tmp.runActionPopupX({
					conversion_name: "ClickButton",
					action: {
						type: "run_tracking_ttq"
					}
				}) : isNullLadiPage(window.ttq) || window.ttq.track("ClickButton"))
			};
		if (!isEmptyLadiPage(a)) {
			var h = !1;
	...
	if (e.runtime.isLoadHtmlGlobal) {
		...
		try {
			...
			d = JSON.parse(Base64.decode(d || Base64.encode("{}"))), Object.keys(d).forEach(function(t) {
		...
		var _ = Object.keys(e.runtime.eventData),
			...
			C = function(t, i, a) {
				if ("FormSubmit" == t && isEmptyLadiPage(f)) isFunctionLadiPage(a) && a();
					...
					})), "PageView" == t && e.runtime.has_popupx && (v++, window.ladi("LADI_PAGE_VIEW").set_cookie(v, 3650)), e.sendRequest("POST", e.const.API_ANALYTICS_EVENT, JSON.stringify(c), !0, {
			...
			X = function() {
				var i, a = document.getElementsByClassName("ladi-form"),
					...
					B = function(t, i) {
						...
						if (p.only(e.runtime.list_set_value_name_country).length == e.runtime.list_set_value_name_country.length)
							for (var g = 0; g < p.length; g++) {
								var _ = e.runtime.list_set_value_name_country.indexOf(p[g]); - 1 != _ && (p[g] = R[_])
							}
					...
					M = function(t, i, a, d, s) {
						...
						isEmptyLadiPage(v) || ["option.sync_ladisales_form_account_id", "option.sync_ladiflow_form_account_id", "option.sync_ladishare_form_account_id", "option.sync_ladichat_form_account_id"].forEach(function(t) {
							isEmptyLadiPage(v[t]) || (isObjectLadiPage(l.options) || (l.options = {}), isArrayLadiPage(l.options.external_form_config_ids) || (l.options.external_form_config_ids = []), l.options.external_form_config_ids.push(v[t]))
						}), isObjectLadiPage(l.options) && (l.options = JSON.stringify(l.options)), isEmptyLadiPage(P) || (l.total_revenue = P), isEmptyLadiPage(e.runtime.time_zone) || (l.time_zone = e.runtime.time_zone);
						...
						if (m.forEach(function(t) {
							...
							isEmptyLadiPage(P) || l.form_data.push({
								name: "cart_revenue",
								value: P,
								is_ladipage: !0
						...
						i.isFormOtp && (i.isSetOtpId && function() {
							...
							var r = new Date,
								d = [];
							isEmptyLadiPage(a) ? d = [e.randomId(), r.getTime(), 1] : ((d = a.split("|"))[1] = parseInt(d[1]) || Date.now(), d[2] = parseInt(d[2]) || 1, i.isSendOtp || (d[2] += 1), d.splice(3)), d[2] <= 1 ? l.otp_send = e.const.OTP_TYPE.send : l.otp_send = e.const.OTP_TYPE.resend, r.setTime(d[1] + 9e5), a = d.join("|"), n ? (o[t] = a, e.runtime.tmp["cookie_cache_otp_" + y] = o) : window.ladi(t).set_cookie(a, r), d.splice(1), a = d.join("|"), l.otp_id = a
					...
					V = function(t, i, a, n) {
						B(a, !1), q(a, !1, null) && (M(0, i, !1, n, function(t) {
							e.sendRequest("POST", e.const.API_FORM_DATA, JSON.stringify(t), !0, {
								"Content-Type": "application/json"
							})
						}), e.showMessage(e.const.LANG.FORM_SEND_DATA_NO_CONFIG), Y(a))
					},
					H = function() {
					...
					G = function(i, a, s, l, g, A) {
						if (N = e.getURLSearchParams(null, null, !1), n = 0, o = null, r = {}, d = {}, c = {}, u = {}, p = {}, m = [], _ = null, y = null, f = null, v = null, P = null, L = null, E = a.captcha_token, isObjectLadiPage(e.runtime.tmp.google_captcha) && (b = e.runtime.tmp.google_captcha.type, !s && isEmptyLadiPage(E) && a.hasOwnProperty("captcha_token"))) H();
						else {
								...
								if (s) {
									...
									if (a.captcha && !isEmptyLadiPage(I) && I["option.form_captcha"] && isObjectLadiPage(e.runtime.tmp.google_captcha)) {
										if (window.grecaptcha)
											...
											x = i.getElementsByClassName("ladi-google-recaptcha-checkbox")[0], D = i.getAttribute("data-button-submit-other"), isEmptyLadiPage(D) || (x = document.querySelector("#" + D + " .ladi-google-recaptcha-checkbox")), R = x.getAttribute("data-widget-id"), F = window.grecaptcha.getResponse(R), G(i, {
												captcha_token: F
											}, s, l, g, A)
									...
									if (a.captcha && !isEmptyLadiPage(I) && I["option.form_captcha"] && isObjectLadiPage(e.runtime.tmp.google_captcha))
										if (window.grecaptcha)
											if (j(), e.runtime.tmp.google_captcha.enterprise && window.grecaptcha.enterprise) window.grecaptcha.enterprise.ready(function() {
												try {
													window.grecaptcha.enterprise.execute(e.runtime.tmp.google_captcha.api_key, {
														action: "submit"
													}).then(function(t) {
										...
										x = i.getElementsByClassName("ladi-google-recaptcha-checkbox")[0], D = i.getAttribute("data-button-submit-other"), isEmptyLadiPage(D) || (x = document.querySelector("#" + D + " .ladi-google-recaptcha-checkbox")), R = x.getAttribute("data-widget-id"), F = window.grecaptcha.getResponse(R), U(), G(i, {
											captcha_token: F
										}, s, l, g, A)
									} catch (t) {
										H(), U()
										...
										var W = I["option.form_send_ladipage"],
											...
											Q = function() {
												...
												if (!Z || isEmptyLadiPage(h)) {
													if (z == e.const.FORM_THANKYOU_TYPE.default && (isEmptyLadiPage(K) || e.showMessage(K, p)), z == e.const.FORM_THANKYOU_TYPE.popup && ($ && e.setDataReplaceElement(!1, !1, p, K), window.ladi(K).show(!1, {
										...
										if (isEmptyLadiPage(_) && isEmptyLadiPage(I["option.sync_ladisales_form_account_id"]) && isEmptyLadiPage(I["option.sync_ladiflow_form_account_id"]) && isEmptyLadiPage(I["option.sync_ladishare_form_account_id"]) && isEmptyLadiPage(I["option.sync_ladichat_form_account_id"])) V(0, A, O, l);
											...
											var it = 0,
												...
												ut = function(t, a, n, o) {
													if (n.readyState == XMLHttpRequest.DONE) {
														...
														s = isObjectLadiPage(s) ? s : {}, o == e.const.API_FORM_DATA ? 200 == s.code ? it++ : (1 != s.code || isEmptyLadiPage(s.message) || (nt = s.message), at++, st = !1) : 200 == a || 201 == a ? it++ : e.getElementAHref(o).host == e.const.DOMAIN_GOOGLE_DOCS ? it++ : at++, it + at == ot.length && (st && !rt && it >= 1 ? (rt = !0, isFunctionLadiPage(A.callbackOtp) && A.callbackOtp(!0), isObjectLadiPage(A) && isFunctionLadiPage(A.callbackThankyou) ? (U(), A.callbackThankyou(A, function() {
															ct(function() {
															...
															e.runEventTracking(i.id, {
																is_form: !0
															}, r), window.ladi("_capture_" + i.id).delete_cookie(), isObjectLadiPage(A) && isFunctionLadiPage(A.callbackOtpDone) && A.callbackOtpDone(), ct(function() {
																e.runTimeout(function() {
											...
											W && M(0, A, s, l, pt), isArrayLadiPage(X) && X.forEach(function(t) {
												if (!isEmptyLadiPage(t.api_url) && isArrayLadiPage(t.custom_fields)) {
													...
													t.custom_fields.forEach(function(t) {
														if (S && ("cart_products" == t.ladi_name && (n = t.name), "cart_revenue" == t.ladi_name && (o = t.name), "cart_shipping" == t.ladi_name && (r = t.name), "cart_coupon_amount" == t.ladi_name && (d = t.name)), !c[t.ladi_name]) {
															var e = u[t.ladi_name];
															isNullLadiPage(e) || (isArrayLadiPage(e) ? 0 == e.length ? a[t.name] = "" : a[t.name] = JSON.stringify(e) : a[t.name] = e)
														}
													}), isEmptyLadiPage(n) || isNullLadiPage(L) || (a[n] = JSON.stringify(L)), isEmptyLadiPage(o) || isNullLadiPage(P) || (a[o] = P), isEmptyLadiPage(r) || isNullLadiPage(e.runtime.tmp.add_to_cart_shipping_method_id) || (a[r] = e.runtime.tmp.add_to_cart_shipping_method_id + "|" + (e.runtime.tmp.add_to_cart_fee_shipping || 0)), isEmptyLadiPage(d) || isEmptyLadiPage(e.runtime.tmp.current_use_coupon) || (a[d] = e.runtime.tmp.add_to_cart_discount || 0);
													var s = {};
											...
											(ot.length > 0 || !W) && j(), e.runTimeout(function() {
												0 == ot.length && (W ? V(0, A, O, l) : M(0, A, s, l, pt)), ot.forEach(function(t) {
									...
									if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.ladisales && !isNullLadiPage(e.runtime.shopping_config_checkout_id)) {
										...
										if (!isEmptyLadiPage(f) && (f = e.findAncestor(f, "ladi-element"), !isEmptyLadiPage(f) && "POPUP_CHECKOUT" == f.id)) return function(t) {
											...
											if (isEmptyLadiPage(i) || isEmptyLadiPage(a)) e.showMessage(e.const.LANG.FORM_INPUT_REQUIRED_ERROR);
												...
												N = e.getURLSearchParams(null, null, !1), k.forEach(function(t) {
							...
							if (!isEmptyLadiPage(a)) {
								...
								if (!isEmptyLadiPage(n)) {
									...
									if (isObjectLadiPage(n["option.form_setting"]) && n["option.form_setting"].is_multiple) {
										if (!n["option.form_setting"].is_multiple_otp) return void j(a, n, !0, t.target.getAttribute("name"), {
											isRunTracking: !0
										});
					...
					tt = function(t) {
						for (var n = a[Z].querySelectorAll('.ladi-element .ladi-form-item-container [name="' + t + '"]'), o = null, r = 0; r < n.length; r++) {
							...
							if (!isEmptyLadiPage(d) && "none" != getComputedStyle(n[r]).display)
								if ("true" != n[r].getAttribute("data-is-select-country") && (d = i[t]), "SELECT" == n[r].tagName) n[r].querySelectorAll('option[value="' + d + '"]').length > 0 && (n[r].value = d, Q && e.fireEvent(n[r], "change"));
								else {
				...
				for (Z = 0; Z < a.length; Z++) {
					...
					for (var at = e.findAncestor(a[Z], "ladi-element"), nt = a[Z].getElementsByClassName("ladi-button"), ot = 0; ot < nt.length; ot++) {
						...
						if (!isEmptyLadiPage(rt)) {
							...
							isEmptyLadiPage(at) || isEmptyLadiPage(e.runtime.eventData[at.id]) || !e.runtime.eventData[at.id]["option.is_add_to_cart"] ? dt.addEventListener("click", K) : (dt.setAttribute("data-click", !1), dt.addEventListener("click", z))
						}
					}
					...
					for (var ct = a[Z].querySelectorAll('input[data-type="date"]'), ut = 0; ut < ct.length; ut++) isEmptyLadiPage(ct[ut].getAttribute("placeholder")) || (e.runtime.isDesktop || e.runtime.isBrowserDesktop ? (ct[ut].setAttribute("type", "text"), ct[ut].addEventListener("focus", et), ct[ut].addEventListener("blur", it)) : ct[ut].value = (new Date).toISOString().substr(0, 10));
					...
					for (pt = a[Z].querySelectorAll("[data-tabindex]"), ut = 0; ut < pt.length; ut++)(gt = parseInt(pt[ut].getAttribute("data-tabindex")) || 0) > mt && (mt = gt), pt[ut].setAttribute("data-tabindex", e.runtime.tabindexForm + gt);
										...
										if (!(isEmptyLadiPage(p) || isEmptyLadiPage(p.store_info) || isEmptyLadiPage(p.product))) {
											...
											e.showParentVisibility(s, function() {
												...
												for (f = 0; f < v.length; f++) {
													...
													u = n[v[f].getAttribute("data-store-id") + "_" + v[f].getAttribute("data-product-id") + "_" + v[f].getAttribute("data-product-option-id")], isNullLadiPage(u) && (p = P[1], isEmptyLadiPage(p) || (u = $(p))), Z(v[f], u)
												}
				...
				if (!isEmptyLadiPage(c)) {
					...
					if ("gallery" == m) {
						...
						y.forEach(function(a, n) {
							b = e.getOptimizeImage(a.src, T.clientWidth, T.clientHeight, !0, !1, !1, t), k += "#" + i + ' .ladi-gallery .ladi-gallery-view-item[data-index="' + n + '"] {background-image: url("' + b + '");}', b = e.getOptimizeImage(a.src, x.clientWidth, x.clientHeight, !0, !1, !1, t), k += "#" + i + ' .ladi-gallery .ladi-gallery-control-item[data-index="' + n + '"] {background-image: url("' + b + '");}'
				...
				if ((isEmptyLadiPage(u) || "print" == u.getAttribute("media")) && (c = {
					...
					if ("popup" == n.type) {
						...
						var m = n[e.runtime.device + ".option.popup_position"],
							g = !1;
						if (isObjectLadiPage(a) && !isNullLadiPage(a.formThankyouPopupXInline) && (g = a.formThankyouPopupXInline), g) return m == e.const.POSITION_TYPE.default ? nt({
						...
						}), window.ladi(t).show(!0), rt(t, i, s, l), !0
					}
					if ("section" == n.type) {
						if (s = (d = dt(t)).isCurrentPopup, l = d.isCurrentSection, n[e.runtime.device + ".option.sticky"]) {
							...
							ot(f.width), c.width = f.width, c.is_sticky_bar = !0, nt({
								id: t,
								data_scale: c,
								dimension: r,
								element: n,
							...
							}), window.ladi(t).show(!0), rt(t, i, s, l)
						}
						return !0
					}
				}
			...
			ut = function() {
				...
				e.changeTotalPriceCart(), e.runtime.tmp.generateLadiSaleProduct(!0), e.runtime.shopping && e.createCartData(), e.loadDataset(null, null, null, null, null, !0, t), _.forEach(function(i) {
						...
						}(i, a.type, a["option.input_type"]), H(i, null, !1, a.type), e.startAutoScroll(i, a.type, a[e.const.DESKTOP + ".option.auto_scroll"], a[e.const.MOBILE + ".option.auto_scroll"]), et(i, a.type, !0, !1), function(t, i) {
							if ("form" == i) {
								var a = document.getElementById(t);
								if (!isEmptyLadiPage(a)) {
							...
							if ("countdown" == i.type)
								for (var a = document.querySelectorAll("#" + t), n = 0; n < a.length; n++) {
									...
									if (g < 0) {
										...
										"true" != o.getAttribute("data-end") && (o.setAttribute("data-end", !0), I(o, i["option.data_event"]), e.runEventTracking(o.id, {
											is_form: !1
										}))
									}
					...
					}), e.runtime.interval_gallery = e.runInterval(G, 1e3), _.forEach(function(t) {
						var i = e.runtime.eventData[t];
						if ("carousel" == i.type) {
							var a = document.getElementById(t);
							if (!isEmptyLadiPage(a)) {
					...
					function() {
						...
						e.runTimeout(function() {
							isFunctionLadiPage(window.gtag) && window.gtag("event", "TimeOnPage_" + t + "_seconds", {
												...
												E = function(l) {
													if (!_ && !isEmptyLadiPage(l)) {
														...
														if (isEmptyLadiPage(e.findAncestor(l, "type")))
															if (isEmptyLadiPage(e.findAncestor(l, "letters"))) isEmptyLadiPage(e.findAncestor(l, "clip")) ? isEmptyLadiPage(e.findAncestor(l, "loading-bar")) ? (h(l, c), e.runTimeout(function() {
																E(c)
		...
		}, e.runtime.tmp.runButtonSectionClose = R, e.runtime.tmp.runOptionAction = x, e.runtime.tmp.runOptionHover = D, e.runtime.tmp.runElementClickSelected = K, e.runtime.tmp.runTrackingAnalytics = C, e.runtime.tmp.runLadiSaleProductKey = at, e.runtime.tmp.eventClickGalleryControlItem = j, e.runtime.tmp.runGallery = H, e.runtime.tmp.setGalleryStart = U, e.runtime.tmp.updateImageGalleryProduct = it, e.runtime.tmp.runOptionCountdown = F, e.runtime.tmp.runOptionCountdownItem = q, e.runtime.tmp.getOptionLabelValue = $, e.runtime.tmp.updateLabelValue = Z, e.runtime.tmp.getLabelValue = Q, e.runtime.tmp.clickLabelProductChangeCallback = tt, e.runtime.tmp.fireEventLabelChange = function(t) {
			var i = t.querySelector(".ladi-form-label-item.selected");
			isEmptyLadiPage(i) || e.fireEvent(i, "click", {
				is_fire_event: !0
			})
		}, e.runtime.tmp.showPopupX = st, e.runtime.tmp.runActionPopupX = nt, e.runtime.is_popupx ? (e.runtime.tmp.popupx_iframe_id = e.randomId(), nt({
			ladipage_id: e.runtime.ladipage_id,
			action: {
			...
			try {
				...
				i.iframe_id == e.runtime.tmp.popupx_iframe_id && i.action.value.forEach(function(t) {
					! function(t, i) {
						...
						"hide_popupx" == t && (a = e.runtime.eventData[i], n = document.getElementById(i), isEmptyLadiPage(a) || isEmptyLadiPage(n) || window.ladi(i).hide()), "show_popupx" == t && st(i, !0), "show_popupx_inline_iframe" == t && lt(i, !0), "show_message_callback" == t && (isFunctionLadiPage(e.runtime.tmp.popupx_show_message_callback) && e.runtime.tmp.popupx_show_message_callback(), delete e.runtime.tmp.popupx_show_message_callback)
					}(i.action.type, t)
				})
			} catch (t) {}
							...
							for (C = 0; C < T.length; C++) {
								...
								for (k = 0; k < T.length; k++)
									if ((R = T[k].getAttribute("data-product-option-id")) != x)
										for (D = T[k].getElementsByTagName("option"), N = 0; N < D.length; N++) isEmptyLadiPage(D[N].getAttribute("value")) || isArrayLadiPage(P[R]) && -1 != P[R].indexOf(D[N].getAttribute("value")) || D[N].setAttribute("disabled", "")
							}
						}
